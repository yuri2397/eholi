...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this._translateService.addLangs(["en", "fr", "ar"]);

    // This language will be used as a fallback when a translation isn't found in the current language
    let defautlLg = localStorage.getItem("lang");
    if(!defautlLg){
        defautlLg = 'ar';
    }
    console.log("LANG", defautlLg)
    this._translateService.setDefaultLang(defautlLg);

    // const browserLang = this._translateService.getBrowserLang();

    this._translateService.use(defautlLg);
    this._coreConfigService.setConfig(
        {app: {appLanguage: defautlLg}},
        {emitEvent: true},
    );

...
export class StudentEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.validateForm = new FormGroup({
      ...
      adress: new FormControl(this.item.adress, [Validators.required, Validators.min(2)]),
      telephone: new FormControl (this.item.telephone, [Validators.required, Validators.min(9)]),
      cni: new FormControl (this.item.cni, [Validators.required, Validators.min(12)]),

...
export class CreateClassCourseComponent implements OnInit {
  ...
  get exam_percent() {
    return this.form.get("exam_percent");
  }

  get duty_percent() {
    return this.form.get("duty_percent");
  }
  ...
  ngOnInit(): void {
    ...
    this.form = new FormGroup({
      ...
      duty_percent: new FormControl(null, [Validators.required]),
      exam_percent: new FormControl(null, [Validators.required]),
      professor_id: new FormControl(null),
  ...
  onClassLevelChange(item: any): any {
    console.log(this.form.value, item.semesters);
    this.semesterList = item.semesters;
  }

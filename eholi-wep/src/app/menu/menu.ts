...
export const menu: CoreMenu[] = [
  ...
  //       icon: 'circle',
  //       url: 'pages/admissions/registrations',
  //     },
  //     {
  ...
  //   type: 'item',
  //   role: ['Super Admin', 'Admin'], //? To set multiple role: ['Admin', 'Client']
  //   icon: 'home',
  //   url: 'dashboard/analytics',
  // },
  // Apps & Pages
